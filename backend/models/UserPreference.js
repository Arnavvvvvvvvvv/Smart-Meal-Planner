...
class UserPreference {
    ...
    static async upsert(userId, preferences) {
        ...
        const res = await db.query(
            `INSERT INTO user_preferences (user_id, dietary_restrictions, allergies, preferred_cuisines, default_servings, measurement_unit)
             ...
             dietary_restrictions = $2, allergies = $3, preferred_cuisines = $4, default_servings = $5, measurement_unit = $6 RETURNING *`,
    ...
    static async findByUserId(userId) {
        const res = await db.query('SELECT * FROM user_preferences WHERE user_id = $1', [userId]);
