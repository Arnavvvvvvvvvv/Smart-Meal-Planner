...
const fetchDashboardData = async () => {
        ...
        const [recipesRes,pantryRes,mealPlanRes,recentRes,upcomingRes] = await Promise.all([
            ...
            api.get('/meal-planning/stats'),
            api.get('/recipe/recent?limit=3'),
            api.get('/meal-planning/upcoming?limit=3')
        ]);
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="mt-1 text-sm text-gray-600 sm:text-base">Welcome back! Here's your cooking overview</p>
                </div>
                ...
                <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <Link
                        to="/generate"
                        className="group rounded-xl bg-linear-to-r from-emerald-50 to-emerald-100 p-4 text-emerald-500 shadow-sm transition-all hover:shadow-md sm:p-6"
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-emerald-800">Create AI-powered recipes</p>
                            </div>
                        </div>
                    </Link>
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-lg font-semibold text-gray-900">Manage Pantry</h3>
                                <p className="text-sm text-gray-600">Add and track ingredients</p>
                            </div>
                        </div>
                    </Link>
                </div>
